        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'post',
              url: "http://192.168.1.6:8080/api/v1/users/login",
              data: {
                email: email,
                password: password
              }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: 'http://192.168.1.6:8080/api/v1/users/logout'
            });
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoia2FybWFueWEwMDciLCJhIjoiY2tmOGJvMTh5MGFwNzJ2bzg4bXloaWNmdiJ9.Et4AG74Esx8_yLuJcUXv7w';
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://192.168.1.6:8080/api/v1/users/updateMyPassword' : 'http://192.168.1.6:8080/api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var stripe = Stripe('pk_test_51HTW54Iiu59lTVrBodPvop5mEX5Ws8EoLOelHssy3Y2A9qwjTGkJWVqMRRI20aSQegKmGWPBpfnXGMBZHFkDQHrg00xFnfERCI');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://192.168.1.6:8080/api/v1/bookings/checkout-session/".concat(tourId));
